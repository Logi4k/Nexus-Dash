  ...
  return (
    <div className="space-y-4" onClick={onClick}>
      ...
      >
        ...
        <div className="absolute -top-2 -right-2 w-20 h-20 rounded-full border border-white/[0.08]" />
        <div className="absolute bottom-8 -left-6 w-24 h-24 rounded-full border border-white/[0.05]" />
