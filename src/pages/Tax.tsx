...
function EditableAmount({
  ...
  return editing ? (
    <div className="flex items-center gap-1">
      ...
      />
      <button onClick={save} className="p-1 rounded hover:bg-profit/10 text-profit"><Check size={12} /></button>
      <button onClick={() => setEditing(false)} className="p-1 rounded hover:bg-loss/10 text-loss"><X size={12} /></button>
    </div>
  ) : (
...
function BRow({
  ...
  return (
    <div className={cn(
      ...
      divider && "border-t border-white/[0.06] mt-1 pt-3",
      indent && "pl-4"
    )}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-5">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            {/* Trading Income */}
            <div className="card p-4 flex flex-col gap-3" style={{ background: "linear-gradient(135deg, rgba(34,197,94,0.06) 0%, transparent 100%)", borderColor: "rgba(34,197,94,0.15)" }}>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold uppercase tracking-wider text-tx-3 flex items-center gap-1.5">
            ...
            {/* Expenses */}
            <div className="card p-4 flex flex-col gap-3" style={{ background: "linear-gradient(135deg, rgba(239,68,68,0.05) 0%, transparent 100%)", borderColor: "rgba(239,68,68,0.12)" }}>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-bold uppercase tracking-wider text-tx-3 flex items-center gap-1.5">
          ...
          <div className="card p-5" style={{ background: theme.dim, border: `1px solid ${theme.border}` }}>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {poaApplies ? (
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-full bg-white/[0.05] text-tx-4 border border-white/10">Not required (bill &lt; £1,000)</span>
                )}
              </div>
            ...
            {poaApplies && (
              <div className="mt-4 grid grid-cols-3 gap-3">
                <div className="rounded-lg p-3 bg-white/[0.04] border border-white/[0.08] text-center">
            ...
            {showPoaInfo && (
              <div className="mt-4 p-3 rounded-lg bg-white/[0.03] border border-white/[0.07] text-xs text-tx-3 space-y-1.5 leading-relaxed">
        ...
        <div className="flex flex-col gap-5">
          ...
          {(() => {
            ...
            const rateColor = marginalRate >= 40 ? "#ef4444" : marginalRate >= 20 ? "#f59e0b" : "#22c55e";
            const dashO = (Math.min(marginalRate, 100) / 100) * circO;
            const innerColor = savingsProgress >= 100 ? "#10b981" : savingsProgress >= 50 ? "#22c55e" : "#f59e0b";
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 flex flex-col gap-2 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[13px] font-black tabular-nums font-mono" style={{ color: totalDueJan31 > 0 ? "#f59e0b" : "#22c55e" }}>
            ...
            {[
              {
                ...
                color: additionalIncomeTax > 0 ? "#f59e0b" : "#22c55e",
              ...
              },
              {
                ...
                color: tradingProfit > 0 ? "#22c55e" : "#6b7280",
              ...
              },
              {
                ...
                color: marginalRate >= 40 ? "#ef4444" : marginalRate >= 20 ? "#f59e0b" : "#22c55e",
              ...
              },
              {
                ...
                color: totalDueJan31 > 0 ? "#f59e0b" : "#22c55e",
            ...
            <div className="card p-4 flex flex-col gap-4" style={{ background: theme.dim, border: `1px solid ${theme.border}` }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex items-center gap-1.5 bg-white/[0.04] border border-white/[0.1] rounded-lg px-2.5 py-2 focus-within:border-profit/40 transition-colors">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div
                    className={cn(
                      "flex items-center gap-1.5 bg-white/[0.04] border rounded-lg px-2.5 py-2 transition-colors",
                      savingsGoalOverride !== null
                        ? "border-accent/30 focus-within:border-accent/50"
                        : "border-white/[0.1] focus-within:border-accent/40",
                    )}
                  >
                    <span className="text-tx-4 text-xs">£</span>
                    <input
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isPast ? "opacity-45 border-white/[0.05]" :
          ...
          <div className="card p-4" style={{ background: theme.dim, border: `1px solid ${theme.border}` }}>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                >
                  <div className="shrink-0 mt-0.5 p-1 rounded" style={{ background: `${t.color}18`, color: t.color }}>{t.icon}</div>
