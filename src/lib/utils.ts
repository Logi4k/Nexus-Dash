...
export const MARKET_SESSIONS: MarketSession[] = [
  { name: "Asia",     startET: "19:00", endET: "03:00", color: "#3ec2c8" },
  { name: "London",   startET: "03:00", endET: "09:30", color: "#8b7da3" },
  { name: "New York", startET: "09:30", endET: "16:15", color: "#4a9a7a" },
];
